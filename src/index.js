...
function runChest() {
  ...
  <table>
    <tr>
      <td>
        <button id="pushChest">Push Chest</button>
      </td>
      <td>
        <button id="pushHead">Push Head</button>
      </td>
    </tr>
    ...
    <tr>
      <td>
        <button data-action="addWidget">Add widget</button>
      </td>
      <td>
        <button data-action="removeWidget">Remove widget</button>
      </td>
    </tr>
  </table>
  `
  ...
  ctfun.addRGBPoint(95, 0.9765, 0.9647, 0.9333)
  ctfun.addRGBPoint(225, 0, 0.6, 0.2)
  ctfun.addRGBPoint(255, 1, 0, 0)
  ...
  actor.getProperty().setGradientOpacityMaximumValue(0, 30)
  ...
  for (let i = 0; i < buttons.length; i++) {
    if (buttons[i].id != "pushHead") {
      buttons[i].addEventListener("click", widgetRegistration)
    }
  }

  document.querySelector("#pushHead").addEventListener("click", runHead)
}
...
function runHead() {
  ...
  document.querySelector("#pushChest").addEventListener("click", runChest)
}

document.body.style.backgroundColor = "#52576e"

document.body.innerHTML = `
<div style="position: absolute; left: 25px; top: 25px; background-color: white; border-radius: 5px; list-style: none; padding: 5px 10px; margin: 0px; display: block; border: 1px solid black; max-width: calc(100% - 70px); max-height: calc(100% - 60px); overflow: auto;">
  <table>
    <tr>
      <td>
        <button id="pushChest">Push Chest</button>
